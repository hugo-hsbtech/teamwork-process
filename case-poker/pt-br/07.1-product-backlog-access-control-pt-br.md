...
> ⚠️ **Dependência externa:** Este épico requer que a equipe de TI da Construtora Ágil registre a plataforma como aplicação aprovada no seu tenant Azure AD e forneça o ID do tenant. Isso deve ser concluído até 2024-04-14 para o prazo de entrega se manter.
...
> ⚠️ **Pré-requisito de infraestrutura:** O endpoint de banco de dados da região do Brasil (`sa-east-1`) deve ser provisionado pelo CTO antes que este épico possa ser entregue. Alvo: 2024-05-05.
