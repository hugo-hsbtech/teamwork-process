...
| Campo | Valor |
|---|---|
| **ID do Backlog** | PB-2026-002 |
| **Versão** | v1 |
| **PRD vinculado** | PRD-2026-002 |
| **Responsável** | Lucas Mendes (PO) |
| **Status** | Baseline — aprovado para breakdown técnico |
| **Data de baseline** | 2026-04-05 |

> Este documento define **o que** será construído e **para quem**, da perspectiva do usuário.
> Não define como será construído. Decisões técnicas, tarefas e abordagem de implementação pertencem ao Tech Backlog (TB-2026-002).

## Histórico de Revisão

| Versão | Data | Autor | Resumo |
|---|---|---|---|
| v1 | 2026-04-05 | Lucas Mendes (PO) | Backlog inicial. Épicos e histórias derivados do PRD-2026-002 (RP v1 + TA-2026-002), incluindo findings do Discovery (Azure AD, LGPD). Baseline alinhada com o PM. |
...
> Dependência externa: este épico exige que a equipe de TI da Construtora Ágil registre a plataforma como aplicação aprovada no tenant Azure AD e forneça o ID do tenant. Precisa estar concluído até 2026-04-14 para o prazo de entrega se manter.
...
> Pré-requisito de infraestrutura: o endpoint de banco de dados na região do Brasil (`sa-east-1`) precisa ser provisionado pelo CTO antes deste épico ser entregue. Alvo: 2026-05-05.
...
| Integração Jira para pré-população de sala | Movido para BACKLOG-2026-007 durante Discovery |
